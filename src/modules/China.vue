...
export default class Province extends Vue {
      ...
      formatter: (params: any) => {
        if (params.data !== undefined) {
          ...
          return (
            ...
            '<div class="tooltip-wrap" style=" width: 320px;height: 240px;rgba(50, 50, 50, 0.7);padding: 16px;">' +
            '<div class="tooltip-top" style=" display: flex;justify-content: space-between;">' +
            '<div class="tooltip-title" style=" font-size: 20px;color: #fff;font-weight: bold;">湖南省</div>' +
            '<div class="count" style=" font-size: 20px;color: #fff;font-weight: bold;">156 <span style="color: #fff;font-weight: normal;font-size: 14px;">个</span></div>' +
            '</div> ' +
            '<div class="tooltip-body" style="margin-top: 24px;">' +
            '<div class="item" style="display: flex;margin-bottom: 16px;">' +
            '<div class="item-left" style="padding: 8px;display: flex;flex-direction: column;justify-content: space-between;margin-right: 8px;background: linear-gradient(90deg, #0fa 0%, rgba(0, 255, 170, 0.5) 100%);">' +
            '<div class="text" style="font-size: 12px;color: #fff;">资规产品链</div>' +
            '<div class="count" style=" font-size: 20px;font-weight: bold;color: #fff;">104<span style="margin-left: 4px;font-weight: normal;font-size: 14px;">个</span></div>' +
            '</div>' +
            '<div class="item-right" style="flex: 1;">' +
            '<div class="text-content" style="margin-bottom: 8px;">' +
            '<div class="text-wrap" style="display: flex;justify-content: space-between;align-items: center;">' +
            '<div class="text" style="color: #fff;font-size: 12px;">智慧应用</div>' +
            '<div class="count" style="font-size: 14px;color: #fff;font-weight: bold;">46<span style="margin-left: 4px;font-weight: normal;">个</span></div>' +
            '</div>' +
            '<div class="line" style="width: 100%;height: 4px;background: #193870;            margin-top: 5px;">' +
            '<div class="inner-line" style="width: 80%;height: 4px;background: linear-gradient(270deg, #00eaff 0%, #0095ff 50%, rgba(0, 149, 255, 0) 100%);"></div>' +
            '</div>' +
            '</div>' +
            '<div class="text-content" style="margin-bottom: 8px;">' +
            '<div class="text-wrap" style="display: flex;justify-content: space-between;align-items: center;">' +
            '<div class="text" style="color: #fff;font-size: 12px;">业务咨询</div>' +
            '<div class="count" style="font-size: 14px;color: #fff;font-weight: bold;">46<span style="margin-left: 4px;font-weight: normal;">个</span></div>' +
            '</div>' +
            '<div class="line" style="width: 100%;height: 4px;background: #193870;            margin-top: 5px;">' +
            '<div class="inner-line" style="width: 80%;height: 4px;background: linear-gradient(270deg, #00eaff 0%, #0095ff 50%, rgba(0, 149, 255, 0) 100%);"></div>' +
  ...
  private initTooltip(params: any) {
    if (params.data !== undefined) {
      const data = params.data
      return (
        data.name + '</br>' + params.marker + '数量：' + data.value
    ...
    .tooltip-body {
      ...
      .item {
        ...
        .item-left {
          ...
          justify-content: space-between;
          margin-right: 8px;
          background: linear-gradient(90deg, #0fa 0%, rgba(0, 255, 170, 0.5) 100%);
          .text {
            font-size: 12px;
            color: #fff;
          }
        ...
        .zjcpl {
          background: linear-gradient(90deg, #ffcf40 0%, rgba(255, 207, 64, 0.5) 100%);
        }
        .item-right {
          flex: 1;
          .text-content {
          ...
          .line {
            ...
            .inner-line {
              width: 80%;
              height: 4px;
              background: linear-gradient(270deg, #00eaff 0%, #0095ff 50%, rgba(0, 149, 255, 0) 100%);
            }
            .ywzx {
              width: 89%;
              background: linear-gradient(270deg, #6dffd6 0%, #0fa 50%, rgba(0, 255, 170, 0) 100%);
            }
          }
        }
      }
